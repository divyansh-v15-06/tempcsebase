...
const HonorsAdmin: React.FC = () => {
    ...
    function handleDelete(id) {
        ...
        axios
            .delete(
                `${process.env.NEXT_PUBLIC_API_URL}/honor/delete/${id}`,
                {
                    headers,
                },
            )
            .then((response) => {
                toast.success('Honors deleted successfully')
                fetchData()
            })
            .catch((error) => {
    ...
    const handleUpdateSubmit = async (formData,id) => {
        axios
            .patch(
                `${process.env.NEXT_PUBLIC_API_URL}/honor/update/${id}`,
                formData,
                {
                    headers,
                },
    ...
    const handleAddSubmit = async (formData) => {
        axios
        .post(
            `${process.env.NEXT_PUBLIC_API_URL}/honor`,
            formData,
            {
                headers,
            },
