...
import AdminModalInternationalExposure from '@/components/admin-components/updateModals/international&nationalExposureUpdateModal'

const AdminInternational: React.FC = () => {
    ...
    function handleDelete(id) {
        ...
        axios
            .delete(
                `${process.env.NEXT_PUBLIC_API_URL}/exposure/delete/${id}`,
                {
                    headers,
                },
            )
            ...
            .catch((error) => {
                toast.error('exposure deleting Honors')
                console.error(error)
            })
    }
    ...
    const handleUpdateSubmit = async (formData,id) => {
        axios
            .patch(
                `${process.env.NEXT_PUBLIC_API_URL}/exposure/update/${id}`,
                formData,
                {
                    headers,
                },
    ...
    const handleAddSubmit = async (formData) => {
        axios
        .post(
            `${process.env.NEXT_PUBLIC_API_URL}/exposure`,
            formData,
            {
                headers,
            },
    ...
    return (
        <>
            <Table
                ...
                fetchData={fetchData}
            />
            <AdminModalInternationalExposure
                isOpen={isModalOpen}
            ...
            <InternationalNationalUpdateModal
    ...
    return (
        <div className='h-[92vh]'>
            <div className='flex justify-between items-center border-b-2 p-4'>
                ...
                >
                    Add Honors & Recognition Achieved
                </button>
            </div>
