...
export default function PublicationsAdmin({}: Props) {
    ...
    const [filter8, setFilter8] = useState<string>('')
    ...
    const fetchData = () => {
        ...
        }/publication/get?startYear=${filter1.trim()}&name=${username}&type=${filter3.trim()}&endYear=${filter5.trim()}&academicSession=${filter6.trim()}&indexing=${filter7.trim()}&journalQuartile=${filter8.trim()}`
    ...
    return (
        <div className='h-[92vh]'>
            ...
            <div className='flex justify-between items-center border-b-2 p-4'>
                <h1 className='font-semibold text-2xl'>{typePublication}</h1>
            ...
            <div className='flex  flex-wrap flex-col lg:flex-row items-center gap-2 mt-3'>
                <div className='flex justify-start pl-[18px]'>
                    ...
                    />
                    <FilterOptions
                        filterName='Journal Quartile'
                        setFilterValue={setFilter8}
                        options={options.journalQuartile}
                    />
                </div>
                ...
                {/* <FilterOptions
                    ...
                    options={facultyName}
                /> */}
                <div className='flex justify-end mr-[1rem] flex-1'>
