...
const AdminModalQualifications: React.FC<{
    isOpen: boolean
    onClose: () => void
    onSubmit: (data: EducationQualification) => void
    ...
    const handleSubmit = (e) => {
        ...
        onSubmit({...formData,facultyId:userid,
            passingYear:formData.passingYear.getFullYear(),
        })
        onClose()
        setFormData({})
    }
...
export default AdminModalQualifications
