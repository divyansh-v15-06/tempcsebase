...
const AdminEquipmentUpdate = ({
    ...
    useEffect(() => {  
        if (IntialData) {
            setFormData({
                ...
                quantity: IntialData.quantity,
                date: IntialData.date,
                stock: IntialData.stock,
                invoice: IntialData.invoice,
                indenter: IntialData.indenter,
                vender: IntialData.vender,
                addressAndCon: IntialData.addressAndCon,
                amount: IntialData.amount,
                academicSession: IntialData.academicSession
            })
        }
    }, [IntialData])
    const handleSubmit = (e) => {
        ...
        onSubmit(updatedFormData,IntialData.id)
        onClose()
    }
...
export default AdminEquipmentUpdate
